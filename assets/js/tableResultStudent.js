...
const auth = getAuth();
  ...
  const searchRollNumber = document.getElementById("rollNoStudent")
...
const filterFaculty = document.getElementById("select_faculty");
const filterSemester = document.getElementById("select_semester");
...
function createAsListForStudent(doc) {
    ...
    // };
    button.onclick = function () {
        sessionStorage.setItem('userEmailForResultView', doc.data().roll_number);
        window.open("../../viewResult.html", "_top");
    };
